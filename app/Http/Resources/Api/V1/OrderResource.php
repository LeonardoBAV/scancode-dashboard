...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'client_cpf_cnpj' => $this->when(array_key_exists('client_cpf_cnpj', $attributes), $this->client_cpf_cnpj),
            'client_corporate_name' => $this->when(array_key_exists('client_corporate_name', $attributes), $this->client_corporate_name),
            'client_fantasy_name' => $this->when(array_key_exists('client_fantasy_name', $attributes), $this->client_fantasy_name),
            'payment_method_name' => $this->when(array_key_exists('payment_method_name', $attributes), $this->payment_method_name),
